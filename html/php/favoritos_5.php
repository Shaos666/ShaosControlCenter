            ...
            <form method="POST">
                ...
                <?php foreach ($favoritos as $fav): ?>
                    <div class="auxiliar_item">
                        ...
                        <label>Título <span class="auxiliar_contador">000</span>
                            <input type="text" name="nome_<?= $fav['id'] ?>" value="<?= htmlspecialchars($fav['nome']) ?>" maxlength="100">
                        </label>
                        <label>URL <span class="auxiliar_contador">000</span>
                ...
                <?php endforeach; ?>
                <button class="auxiliar_botao" type="submit" name="salvar_edicoes">Salvar Alterações</button>
            </form>
        </div>
